...
test('should return list with nested array lists', (expect) => {
    //Arrange
    // Set up your arguments and expectations
    const expected = `<div class="robots" id="robotlist">
    <h2>BENDER</h2>
    <ul>
        <li>Futurama</li>
        <li>"O cruel fate, to be thusly boned! Ask not for whom the bone bones—it bones for thee.”</li>
        <li>Bender would like to kill all humans</li>
    </ul>
</div>`;
    
    //Act 
    // Call the function you're testing and set the result to a const
    const actual = renderRobots(robots);
